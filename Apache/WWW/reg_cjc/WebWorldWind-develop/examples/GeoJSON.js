...
requirejs(['./WorldWindShim',
    ...
    function (WorldWind,
     ...
     /*   var polygonLayer = new WorldWind.RenderableLayer("Polygon");
		...
		var cjcLayer = new WorldWind.RenderableLayer("cjcLayer");
        var cjcGeoJSON = new WorldWind.GeoJSONParser("http://localhost:8079/data/System/geojson/map.geojson");
        cjcGeoJSON.load(null, shapeConfigurationCallback, cjcLayer);
        wwd.addLayer(cjcLayer);
